...
sudo openconnect vpn2.vu.lt --user=1543349 -F main:password=JGU!hpm*zan*zuz5tze
...
sh -c "git config --global core.askPass /Users/kernius/graffinity/backend-graffinity/.github/workflows/entrypoint.sh"
sh -c "git config --global credential.helper cache"
sh -c "git remote add mirror https://git.mif.vu.lt/graffinity/graffinity-backend"
